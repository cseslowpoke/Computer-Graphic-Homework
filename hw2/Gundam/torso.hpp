...
class torso {
  ...
  float point2[12][3] = {{0, 0, 2}, {0, 0, -1}, {5, 0, 5}, {5, 0, 4}, {-5, 0, 5}, {-5, 0, 4},
                          {0, 0.3, 2}, {0, 0.3, -1}, {5, 0.3, 5}, {5, 0.3, 4}, {-5, 0.3, 5}, {-5, 0.3, 4}};
  int face2[10][4] = {{0, 1, 3, 2},{0, 1, 5, 4},{6, 7, 9, 8},{6, 7, 11, 10},{0, 2, 8, 6}, {0, 4, 10, 6},
                      {1, 3, 9, 7}, {1, 5, 11, 7}, {2, 3, 9, 8}, {4, 5, 11, 10}};
